            ...
            <div class="card bg-dark p-3 text-center text-white">
                ...
                @csrf
                 ...
                 <?php
                    ...
                    <li class='list-group-item list-group-item-success text-start'>{{ Session::get('message') }}</li>
                    @endif
                    @if(Session::has('errorMsg'))
                    <li class='list-group-item list-group-item-danger text-start'>{{ Session::get('errorMsg') }}</li>
                    @endif
